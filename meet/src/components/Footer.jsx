...
">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-12 mb-16">
          ...
          {/* Developer Profiles */}
          <div className="space-y-6">
            <h4 className="text-[10px] font-black text-zinc-900 dark:text-zinc-100 uppercase tracking-widest">Core Developers</h4>
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between group border-b border-zinc-50 pb-2">
                ...
                <div className="flex gap-3">
                  <a href="https://linkedin.com/in/username2" target="_blank" className=" hover:text-zinc-900 transition-colors"><Linkedin size={16}/></a>
          ...
          <div className="space-y-6 md:text-right">
            <h4 className="text-[10px] font-black text-zinc-900 dark:text-zinc-100 uppercase tracking-widest">Platform</h4>
